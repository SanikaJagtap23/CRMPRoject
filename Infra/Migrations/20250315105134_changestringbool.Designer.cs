...
namespace Infra.Migrations
{
    ...
    [Migration("20250315105134_changestringbool")]
    partial class changestringbool
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domine.PurchaseInvoiceTerms", b =>
                {
                    ...
                    b.HasIndex("SalesInvoiceTermsAndConditionID");
            ...
            modelBuilder.Entity("Domine.SalesInvoiceTermsAndCondition", b =>
                {
                    ...
                    b.Property<long?>("SalesInvoiceTermsAndConditionID1")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("SalesInvoiceTermsAndConditionID1");
            ...
            modelBuilder.Entity("Domine.PurchaseInvoiceTerms", b =>
                {
                    ...
                    b.HasOne("Domine.SalesInvoiceTermsAndCondition", "SalesInvoiceTermsAndCondition")
                        .WithMany()
                        .HasForeignKey("SalesInvoiceTermsAndConditionID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("SalesInvoice");

                    b.Navigation("SalesInvoiceTermsAndCondition");
                });
            ...
            modelBuilder.Entity("Domine.SalesInvoiceTermsAndCondition", b =>
                {
                    ...
                    b.HasOne("Domine.SalesInvoiceTermsAndCondition", null)
                        .WithMany("SalesInvoiceTermsAndConditions")
                        .HasForeignKey("SalesInvoiceTermsAndConditionID1")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("Domine.SalesInvoiceTermsAndCondition", b =>
                {
                    b.Navigation("SalesInvoiceTermsAndConditions");
                });
